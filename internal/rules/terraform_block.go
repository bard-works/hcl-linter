...
func (r TerraformBlockRule) Check(ctx *Context) []linter.Issue {
...
func checkTFSourceRequired(issues *[]linter.Issue, attrs map[string]hcl.Expression, block *hclsyntax.Block) {
...
func checkTFVersionFormat(issues *[]linter.Issue, attrs map[string]hcl.Expression) {
...
func checkTFExtraArguments(issues *[]linter.Issue, body hcl.Body) {
...
func checkTFDeprecatedFields(issues *[]linter.Issue, body hcl.Body) {
